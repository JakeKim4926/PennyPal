...
public class AccountTransactionListResponseDTO {
    ...
    @Builder
    public AccountTransactionListResponseDTO(String transactionUniqueNo, String transactionDate, String transactionType, String transactionSummary, String transactionAccountNo) {
